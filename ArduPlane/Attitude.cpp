...
float Plane::stabilize_pitch_get_pitch_out()
{
    ...
    */
    ...
    if (should_run_tecs() && TECS_controller.get_up_accel_demand(up_accel_demand)) {
        return pitchController.get_servo_out_accln(up_accel_demand, speed_scaler, TECS_controller.get_pitch_min(), TECS_controller.get_pitch_max());
    } else {
