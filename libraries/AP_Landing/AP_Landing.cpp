...
const AP_Param::GroupInfo AP_Landing::var_info[] = {
    ...
    // @Bitmask: 0: honor min throttle during landing flare,1: Increase Target landing airspeed constraint From Trim Airspeed to ARSPD_FBW_MAX,2: Allow TECS to plan the vertical and horizontal trajectory
    // @User: Advanced
