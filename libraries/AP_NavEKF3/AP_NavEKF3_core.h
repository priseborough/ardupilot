/*
  25 state EKF based on the derivation in https://github.com/PX4/ecl/
...
public:
    ...
    void getStateVariances(float stateVar[25]);
...
private:
    ...
    typedef VectorN<VectorN<ftype,25>,25> Matrix25;    typedef VectorN<uint32_t,50> Vector_u32_50;
#else
    ...
    // the states are available in two forms, either as a Vector25, or
