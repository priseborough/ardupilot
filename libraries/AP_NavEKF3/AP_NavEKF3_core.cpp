...
/*
 * Calculate the predicted state covariance matrix using explicit algebraic equations auto-generated
 * from libraries/AP_NavEKF3/python/main.py with output recorded in libraries/AP_NavEKF3/python/covariance_generated.cpp
*/
