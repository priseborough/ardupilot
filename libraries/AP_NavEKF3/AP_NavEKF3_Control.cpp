...
void NavEKF3_core::setWindMagStateLearningMode()
{
    ...
    if (tiltAlignComplete && inhibitDelVelBiasStates && (frontend->_highAccuracyMask & (1U<<core_index)) == 0) {
        // activate the states
    ...
    if (tiltAlignComplete && inhibitDelAngBiasStates && (frontend->_highAccuracyMask & (1U<<core_index)) == 0) {
        // activate the states
