...
NavEKF3_core::MagCal NavEKF3_core::effective_magCal(void) const
{
    ...
    if (magcal != MagCal::EXTERNAL_YAW && magcal != MagCal::EXTERNAL_YAW_FALLBACK && magcal != MagCal::GPS_YAW && (frontend->_magMask & core_index)) {
        return MagCal::NEVER;
    }
...
bool NavEKF3_core::use_compass(void) const
{
    return effectiveMagCal != MagCal::EXTERNAL_YAW &&
           effectiveMagCal != MagCal::GPS_YAW &&
           _ahrs->get_compass() &&
...
void NavEKF3_core::checkGyroCalStatus(void)
{
    ...
    if (effective_magCal() == MagCal::GPS_YAW) {
