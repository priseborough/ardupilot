...
void  NavEKF3_core::updateFilterStatus(void)
{
    ...
    bool doingRelExtNav = (PV_AidingMode != AID_NONE) && (imuSampleTime_ms - extNavDelPosFuseTime_ms < 5000);
    ...
    filterStatus.flags.horiz_pos_rel = ((doingFlowNav && gndOffsetValid) || doingWindRelNav || doingNormalGpsNav || doingBodyVelNav || doingRelExtNav) && filterHealthy;   // relative horizontal position estimate valid
