...
const AP_Param::GroupInfo NavEKF3::var_info[] = {
    ...
    // @Values: 0:When flying,1:When manoeuvring,2:Never,3:After first climb yaw reset,4:Always,5:Use external yaw sensor (Deprecated in 4.1+ see EK3_SRCn_YAW),6:External yaw sensor with compass fallback (Deprecated in 4.1+ see EK3_SRCn_YAW). EK3_MAG_CAL = 7 uses 3-axis fusion at all times but with additional protection for ground based magnetic interference before the final in flight magnetic field reset has been performed.
    // @User: Advanced
    // @RebootRequired: True
