...
const AP_Param::GroupInfo NavEKF3::var_info2[] = {
    ...
    // @Param: DV_YAW_1
    // @DisplayName: Learned doppler velocity sensor 1 yaw offset
    // @Description: Learned doppler velocity sensor 1 yaw offset
    // @User: Advanced
    // @Units: deg
    AP_GROUPINFO("DV_YAW_1", 13, NavEKF3, _dopplerYawOffset[1], 0.0f),

    // @Param: DV_YAW_2
    // @DisplayName: Learned doppler velocity sensor 2 yaw offset
    // @Description: Learned doppler velocity sensor 2 yaw offset
    // @User: Advanced
    // @Units: deg
    AP_GROUPINFO("DV_YAW_2", 14, NavEKF3, _dopplerYawOffset[2], 0.0f),

    // @Param: DV_YAW_3
    // @DisplayName: Learned doppler velocity sensor 3 yaw offset
    // @Description: Learned doppler velocity sensor 3 yaw offset
    // @User: Advanced
    // @Units: deg
    AP_GROUPINFO("DV_YAW_3", 15, NavEKF3, _dopplerYawOffset[3], 0.0f),

    // @Param: DV_PIT_0
    // @DisplayName: Learned doppler velocity sensor 0 pitch offset
    // @Description: Learned doppler velocity sensor 0 pitch offset
    // @User: Advanced
    // @Units: deg
    ...
    // @Param: DV_PIT_2
    // @DisplayName: Learned doppler velocity sensor 2 pitch offset
    // @Description: Learned doppler velocity sensor 2 pitch offset
    // @User: Advanced
    // @Units: deg
...
void NavEKF3::writeDopplerVel(float vel, float velErr, float rng, float rngErr, float yaw, float pitch, uint32_t timeStamp_ms, uint8_t Id, uint8_t N_sensors)
{
    AP::dal().writeDopplerVel(vel, velErr, rng, rngErr, yaw, pitch, timeStamp_ms, Id, N_sensors);

    if (core) {
        for (uint8_t i=0; i<num_cores; i++) {
            core[i].writeDopplerVel(vel, velErr, rng, rngErr, yaw, pitch, timeStamp_ms, Id, N_sensors);
        }
    }
}
