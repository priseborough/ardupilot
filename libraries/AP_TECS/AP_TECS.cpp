...
void AP_TECS::update_50hz(void)
{
    ...
    if (_ahrs.get_velocity_NED(velned)) {
        ...
        if (_flags.reset) {
            _height_filter.height = baro_alt;
        } else {
...
void AP_TECS::_update_height_demand(void)
{
    ...
    if (!_update_landing_trajectory()) {
        ...
        if (!_landing.is_flaring()) {
            ...
            // noting that when flare is aborted the height reference changes to home
...
bool AP_TECS::_update_landing_trajectory(void)
{
    ...
    case flareTrajectoryStatus::NONE:
        if (!is_zero(_land_posx)) {
            ...
            // that passes through or above the aim point .
            // y = a1 * x + b1
            ...
            // post flare fullup, fly a straight line from the aim point
            ...
            if (is_negative(_land_entry_posx)) {
                ...
                gcs().send_text(MAV_SEVERITY_INFO, "TECS landing plan overshoot");
