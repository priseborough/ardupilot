...
void  AP_AHRS::writeDopplerVel(float dopplerVel, float dopplerVelErr, float rng, float rngErr, float sensorYaw, float sensorPitch, uint32_t timeStamp_ms, uint8_t Id, uint8_t N_sensors)
{
#if HAL_NAVEKF3_AVAILABLE
    EKF3.writeDopplerVel(dopplerVel, dopplerVelErr, rng, rngErr, sensorYaw, sensorPitch, timeStamp_ms, Id, N_sensors);
#endif
}
