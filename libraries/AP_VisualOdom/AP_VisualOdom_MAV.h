...
public:
    ...
    void handle_pose_estimate(uint64_t remote_time_us, uint32_t time_ms, float x, float y, float z, const Quaternion &attitude, const float posCov[6], float angErr, uint8_t reset_counter, int8_t quality) override;
